//! `nf_editor_voxel_tools` — voxel painting, sculpting, and structure tools.
//!
//! # Overview
//! This crate wires four closely related features into the NovaForge editor:
//!
...
use nf_commands::{CommandHistory, EditorCommand, EditorCommandContext};
...
fn draw_voxel_palette_panel(
    ...
    egui::SidePanel::right("nf_voxel_tools")
        .default_width(180.0)
        .resizable(true)
        .show(ctx, |ui| {
